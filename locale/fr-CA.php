...
return array(
    ...
    "torrent_search_button" => "Chercher les bit-torrents avec LibreY",
    ...
    "donate_original_developer" => "Donner au développeur original de %s, un projet LibreY essaye d'améliorer.",
    "donate_fork" => "Donner à la personne qui a dérivé LibreY de %s",

    "api_unavailable" => "Ce API de LibreY est indisponible en ce moment"
);
